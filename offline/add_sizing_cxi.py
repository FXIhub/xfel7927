...
parser.add_argument('--smin', type=float, default=5e-9, help='minimum particle diameter')
parser.add_argument('--smax', type=float, default=100e-9, help='maximum particle diameter')
